...
class ScreenUtil {
  ...
  /// screen height - statusBar height - bottomBar height
  /// 屏幕安全区 高
  double get screenSafeHeight => _screenHeight - _statusBarHeight - _bottomBarHeight;
  ...
  /// screen height - statusBar height - bottomBar height
  /// 当前屏幕安全区 高
  static double getSafeScreenH(BuildContext context) {
    MediaQueryData mediaQuery = MediaQuery.of(context);
    return mediaQuery.size.height - mediaQuery.padding.top - mediaQuery.padding.top;
  }
